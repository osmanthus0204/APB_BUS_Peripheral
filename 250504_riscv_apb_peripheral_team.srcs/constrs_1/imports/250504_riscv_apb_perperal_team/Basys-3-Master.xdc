...
set_property -dict { PACKAGE_PIN N17   IOSTANDARD LVCMOS33 } [get_ports {trig2}];#Sch name = JC3
set_property -dict { PACKAGE_PIN P18   IOSTANDARD LVCMOS33 } [get_ports {echo2}];#Sch name = JC4
...
set_property -dict { PACKAGE_PIN M2   IOSTANDARD LVCMOS33 } [get_ports {echo1}];#Sch name = XA3_P
set_property -dict { PACKAGE_PIN N2   IOSTANDARD LVCMOS33 } [get_ports {trig1}];#Sch name = XA4_P
