...
module MCU (
    ...
    logic [31:0] PRDATA_ULT1;
    logic [31:0] PRDATA_ULT2;
    ...
    APB_Master U_APB_Master (
        ...
        .PRDATA10(PRDATA_ULT1),
        .PRDATA11(PRDATA_ULT2),
        .PREADY0 (PREADY_RAM),
        .PREADY1 (PREADY_GPO),
        .PREADY2 (PREADY_GPI),
        ...
        .PREADY10(PREADY_ULT1),
        .PREADY11(PREADY_ULT2)
    );
    ...
    Ultrasonic_Periph U_Ultrasonic_Periph1 (
        .*,
        .PSEL   (PSEL_ULT1),
        .PRDATA (PRDATA_ULT1),
        .PREADY (PREADY_ULT1),
    ...
    Ultrasonic_Periph U_Ultrasonic_Periph2 (
        .*,
        .PSEL   (PSEL_ULT2),
        .PRDATA (PRDATA_ULT2),
        .PREADY (PREADY_ULT2),
