...
module ultrasonic_sensor (
    ...
    output logic [31:0] uar,      //ultrasonic ascii register
    // output logic [ 7:0] ascii_digit_1, //ultrasonic ascii register
    // output logic [ 7:0] ascii_digit_10, //ultrasonic ascii register
    // output logic [ 7:0] ascii_digit_100, //ultrasonic ascii register
    // output logic [ 7:0] ascii_digit_1000, //ultrasonic ascii register
    ...
    assign uar = {ascii_digit_1000, ascii_digit_100, ascii_digit_10, ascii_digit_1};
    ...
    Data2Ascii U_Data2Ascii(
    .x(udr),
    .ascii_digit_1(ascii_digit_1),
    .ascii_digit_10(ascii_digit_10),
    .ascii_digit_100(ascii_digit_100),
    .ascii_digit_1000(ascii_digit_1000)
);
endmodule
...
module Data2Ascii (
    input  logic [11:0] x,
    output logic [ 7:0] ascii_digit_1,
    output logic [ 7:0] ascii_digit_10,
    output logic [ 7:0] ascii_digit_100,
    output logic [ 7:0] ascii_digit_1000
);
    assign ascii_digit_1    = (x % 10) + 8'h30;
    assign ascii_digit_10   = (x / 10 % 10) + 8'h30;
    assign ascii_digit_100  = (x / 100 % 10) + 8'h30;
    assign ascii_digit_1000 = (x / 1000 % 10) + 8'h30;
