...
module APB_Decoder (
    ...
    always_comb begin
        ...
        if (en) begin
            casex (sel)
                32'h1000_0xxx: y = 12'b000000000001;
                32'h1000_1xxx: y = 12'b000000000010;
                32'h1000_2xxx: y = 12'b000000000100;
                32'h1000_3xxx: y = 12'b000000001000;
                32'h1000_4xxx: y = 12'b000000010000;
                32'h1000_5xxx: y = 12'b000000100000;
                32'h1000_6xxx: y = 12'b000001000000;
                32'h1000_7xxx: y = 12'b000010000000;
                32'h1000_8xxx: y = 12'b000100000000;
                32'h1000_9xxx: y = 12'b001000000000;
                32'h1001_0xxx: y = 12'b010000000000;
                32'h1001_1xxx: y = 12'b100000000000;
            endcase
        end
    end
endmodule
